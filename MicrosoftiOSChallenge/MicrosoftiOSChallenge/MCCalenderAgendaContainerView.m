...
-(void)setUpSubViewsWithStackView{
    
    self.translatesAutoresizingMaskIntoConstraints = NO;
    UIStackView *containerStackView = ({
        
        //Initializing stackview with default values
...
//        [[[_topView heightAnchor] constraintEqualToConstant:250] setActive:YES];
//        [[[_topView widthAnchor] constraintGreaterThanOrEqualToConstant:350] setActive:YES];
//        _topView.frame.size = CGSizeMake(_topView.frame.size.width, 500);
        _topView;
...
//        [[[_bottomView heightAnchor] constraintGreaterThanOrEqualToConstant:300] setActive:YES];
//        [[[_bottomView widthAnchor] constraintGreaterThanOrEqualToConstant:350] setActive:YES];
        _bottomView;
    ...
    [self addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"H:|[containerStackView]|"
                                             options:0 metrics:nil
                                               views:@{@"containerStackView":containerStackView}]
     ];
    //Adding vertical contraints for topView
    [self addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"V:|[containerStackView]|"
                                             options:0 metrics:nil
                                               views:@{@"containerStackView":containerStackView}]];
    
//    self.topConstraint = [NSLayoutConstraint constraintWithItem:self.topView attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0f constant:300.0f];

//    [self addConstraints:
//     [NSLayoutConstraint constraintsWithVisualFormat:@"V:[topView(400)]"
//                                             options:0 metrics:nil
//                                               views:@{@"topView":_topView}]];
//    [self.topView addConstraint:self.topConstraint];
    [self layoutIfNeeded];
